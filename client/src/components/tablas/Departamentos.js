...
const Departamentos = ({ getDepartamentos, CreateXML, candidatos: {candidatos , loading}} ) => {
...
export default connect(mapStateToProps, { getDepartamentos, CreateXML })(Departamentos)
